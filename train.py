...
if __name__ == '__main__':
    ...
    CUDA_VISIBLE_DEVICES=1 python train.py --normalize_frames True True --num_gpus=1 --model_dir='../puffer_515_v2' --data_dir='../../UserVerificationSystem/data/TRAIN/puffer515' --encoder='rescnn' --input_feature='fbank' --input_feature_dim=64 --filters 64 128 256 512 --blocks=3 --kernel_size=5 --strides=2 --embedding_size=512 --window_size_ms=25 --desired_ms=1200 --window_stride_ms=10 --magnitude_squared=True --batch_size=128 --triplet_strategy='batch_hard' --margin=0.2 --squared=True --num_steps=126000 --learning_rate=0.01 --learning_rate_decay_rate=0.5 --learning_rate_decay_steps=2520 --l2_regularization_weight=0.00001 --triplet_loss_weight=1 --cross_entropy_loss_weight=0
    tensorboard --logdir=../puffer_515_v2/
    '''
